<?php
				...
				/*** This helper firest used pdate function from vahid sohrablo but now its change ***/
...
Class jCalendar {
	...
	*/
	...
	private function ReturnMonthName($monname=0)
	{
		$mon = (int) $monname;
...
## added by rezaonline
	...
	function pdate($pattern ='j F Y' , $timestamp = null)
	{
		$boplo = new jCalendar;
		$boplo->farsiDigits = false; 
		if($timestamp ===null) $timestamp = time();
		return $boplo->date($pattern , $timestamp,3.5);	
	}
...
## added by rezaonline	
	...
	function pmktime($hour= 0, $minute= 0, $second= 0, $month= 0, $day= 0, $year= 0, $is_dst= -1)
	{
		...
		$boplo = new jCalendar;
		$boplo->farsiDigits = false;
		return $boplo->mktime($hour, $minute, $second, $month, $day, $year);
	}
